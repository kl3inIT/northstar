...
const briefsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: 'briefs',
  component: lazyRouteComponent(() => import('@/pages/briefs'), 'BriefsPage'),
})
...
const projectRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: 'projects/$id',
  component: lazyRouteComponent(() => import('@/pages/projects'), 'ProjectDetailPage'),
})
...
const habitsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: 'habits',
  component: lazyRouteComponent(() => import('@/pages/habits'), 'HabitsPage'),
})
