 ...
 * document or viewport changes. Shared by the wiki-link and heading decoration
 * plugins, which differ only in their `build` function.
 *
 * Adapted from usememos/memos (MIT) — its MemoEditor "decorated source" editor.
 */
