...
| Settings GET/update/reset and secret boundary | Automated | `WebResearchControllerIntegrationTests` runs Flyway V26 on PostgreSQL, checks configured metadata, round-trips the override, resets defaults, and asserts no key is exposed. |
