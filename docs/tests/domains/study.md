...
| Grammar-weakness corpus aggregation | Automated | `core/src/test/java/com/northstar/core/study/WritingServiceTests.java` pins case-insensitive grouping, recency-first ordering with freshest label casing, example capping, malformed-JSON tolerance, and the empty history. |
