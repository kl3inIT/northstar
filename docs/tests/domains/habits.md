...
| Typed web API and pure view helpers | Automated | Generated OpenAPI client plus colocated Vitest coverage in `web/src/features/habits/habit-utils.test.ts`; `pnpm -C web test`, typecheck, lint, and production build pass. |
