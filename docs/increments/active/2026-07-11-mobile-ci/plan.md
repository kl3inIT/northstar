...
- [x] Inspect existing CI conventions and mobile platform configuration.
- [x] Add the path-scoped Linux and macOS workflow.
- [x] Cache the pinned official Flutter SDK and package caches.
- [x] Upload Android and unsigned iOS review artifacts.
