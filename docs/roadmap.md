...
| Vocabulary review V1 | Done | Focused keyboard-first weak-card sessions on `/study`, default IPA/pinyin and part of speech, advisory answer checks, learner-owned Ebisu ratings, pronunciation, and explicit preview/apply AI enrichment. Chat remains an optional card-capture and quiz path; there are still no due dates or synthetic intervals. |
